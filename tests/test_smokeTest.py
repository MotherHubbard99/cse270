...
class TestSmokeTest():
  ...
  def test_smokeJoin(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("IVanna")
    self.driver.find_element(By.NAME, "lname").send_keys("Pee")
    self.driver.find_element(By.NAME, "bizname").send_keys("Bathrooms R Us")
    self.driver.find_element(By.NAME, "biztitle").send_keys("Professional Urinator")
  ...
  def test_smoke2(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1189, 798)
